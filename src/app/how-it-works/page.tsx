...
import { Code, Image, Rss } from 'lucide-react';
      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        ...
        <div className="space-y-12">
          ...
          <Card className="animate-fade-in-up" style={{ animationDelay: '400ms' }}>
            <CardHeader>
              <CardTitle className="flex items-center gap-3 text-3xl">
                <Rss className="h-8 w-8 text-accent rotate-90" />
            ...
            <CardContent className="space-y-6 text-base">
                ...
                <div className="space-y-4">
                    ...
                    <div className="p-4 bg-muted/50 rounded-lg flex items-center justify-center gap-4 text-center">
                        <div>
                            <div className="w-16 h-16 rounded-full bg-red-500 mx-auto"></div>
                            <p className="mt-2 font-mono text-sm text-foreground">R: 212</p>
                        </div>
                         <div>
                            <div className="w-16 h-16 rounded-full bg-green-500 mx-auto"></div>
                            <p className="mt-2 font-mono text-sm text-foreground">G: 85</p>
                        </div>
                         <div>
                            <div className="w-16 h-16 rounded-full bg-blue-500 mx-auto"></div>
...
<div>B: 140  -&gt;  1000110<span className="text-yellow-400 font-bold">0</span></div>
                 ...
                 <div className="space-y-4">
                    ...
                    <p className="text-muted-foreground">This is where the magic happens. We can take a secret message, convert it to binary, and then replace the LSB of each color component in the image with the bits of our secret message.</p>
                    <p className="text-muted-foreground">Let's say we want to hide the letter "H", which is `01001000` in binary. We would need 8 LSBs to hide it. We could take the first three pixels and replace their R, G, and B LSBs like this:</p>
                     <pre className="p-4 bg-gray-800 text-green-300 rounded-md text-sm font-mono overflow-x-auto">
                        <code className="whitespace-pre">
{`Original Pixel 1 (RGB): 11010100 01010101 10001100
Secret Bits to Hide:      0        1        0

Modified Pixel 1 (RGB): 11010101 01010100 10001101
(Values change by at most +/- 1, which is invisible)
`}
                        </code>
                    </pre>
